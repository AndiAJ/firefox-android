...
class FeatureSettingsHelperDelegate : FeatureSettingsHelper {
    ...
    override var enableTabsTrayToCompose: Boolean by updatedFeatureFlags::enableTabsTrayToCompose
    ...
    private fun applyFeatureFlags(featureFlags: FeatureFlags) {
        ...
        settings.enableTabsTrayToCompose = featureFlags.enableTabsTrayToCompose
